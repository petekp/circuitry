...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `review` | `public` | `src/flows/review/data.ts`<br>`src/flows/review/flow.ts`<br>generates `src/flows/review/schematic.json` | `generated/flows/review/circuit.json` | `plugins/claude/skills/review/circuit.json`<br>`plugins/codex/flows/review/circuit.json` | `src/flows/review/command.md` | `plugins/claude/commands/review.md`<br>`plugins/codex/commands/review.md`<br>`plugins/codex/skills/review/SKILL.md` | Edit the flow package source; run `npm run emit-flows`. |
...
| `pursue` | `public` | `src/flows/pursue/data.ts`<br>`src/flows/pursue/flow.ts`<br>generates `src/flows/pursue/schematic.json` | `generated/flows/pursue/circuit.json` | `plugins/claude/skills/pursue/circuit.json`<br>`plugins/codex/flows/pursue/circuit.json` | none | none | Edit the flow package; run `npm run emit-flows`. |

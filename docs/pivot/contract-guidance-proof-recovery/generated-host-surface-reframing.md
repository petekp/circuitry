...
| [src/commands/run.md](../../../src/commands/run.md) | The current run command now says it is the intent front door, treats host flow choice as a recommendation, and labels direct flow commands as expert controls rather than bypasses. See `src/commands/run.md:1-23` and `src/commands/run.md:213-223`. |
| [plugins/codex/skills/run/SKILL.md](../../../plugins/codex/skills/run/SKILL.md) | The current generated Codex run skill says Circuit runs from the intent front door and records flow selection, trace, reports, and evidence. See `plugins/codex/skills/run/SKILL.md:1-25` and `plugins/codex/skills/run/SKILL.md:30-57`. |
...
| --- | --- | --- |
| Run command story | `src/commands/run.md` now presents `run` as the intent front door and direct flow commands as expert controls. See `src/commands/run.md:13-23` and `src/commands/run.md:213-221`. | Keep `run` as the intent front door. Host flow choice is a recommendation that Circuit validates and records. |
| Codex run skill | Current generated skill says Circuit runs from the intent front door and records selected flow, trace, reports, and evidence. See `plugins/codex/skills/run/SKILL.md:1-25` and `plugins/codex/skills/run/SKILL.md:30-57`. | Codex run skill keeps saying Circuit runs an intent and records the selected flow. |
| Direct flow command copy | Current Build/Fix/Prototype sources say they are expert controls that still use the same runtime evidence path. See `src/flows/build/command.md:6-20`, `src/flows/fix/command.md:6-20`, and `src/flows/prototype/command.md:6-20`. | Direct flow commands keep saying they are expert controls that still use the same contract, guidance, proof, recovery, checkpoint, trace, and safe apply rules. |

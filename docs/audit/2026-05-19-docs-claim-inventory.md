...
| --- | --- | --- | --- | --- |
| Circuit is the canonical project name and the live CLI/config/runtime namespace after the hard cutover. | `README.md`, `AGENTS.md`, `docs/generated-surfaces.md` | `package.json`, `plugins/*/.*-plugin/plugin.json`, `bin/circuit`, generated host surfaces | Current | Keep old-name references only in explicitly archived historical records; no live support path should remain. |

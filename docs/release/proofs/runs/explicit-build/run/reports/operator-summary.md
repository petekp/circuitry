...
- Run note: checkpoint 'frame-step' is waiting for an operator choice.
...
- Run folder: <repo>/docs/release/proofs/runs/explicit-build/run

## Reports

- Checkpoint request: <repo>/docs/release/proofs/runs/explicit-build/run/reports/checkpoints/frame-step-request.json

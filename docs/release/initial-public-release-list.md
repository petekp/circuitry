...
- `docs/release/readiness-report.generated.md`
...
| REL-PUB-015 | Public `/circuit:pursue` slash command. | Pursue is a public routable flow and has generated flow mirrors, but `docs/generated-surfaces.md` and `src/commands/run.md` say it has no dedicated command surface yet. |

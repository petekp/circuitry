...
import { packageTreeStatus } from './plugin-package-tree.mjs';
...
function noAmbientCliEnv(extra = {}) {
  return {
    ...process.env,
...
function runDoctor(scriptPath, env = {}) {
...
function launcherPathFromCommand(command) {
...
function codexHookSummary(codexHome) {

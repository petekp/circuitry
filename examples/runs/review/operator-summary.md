...
Circuit finished Review. Verdict: CLEAN. Findings: 0.

## What Happened

- Selected flow: `review`
- Outcome: `complete`
- Routed by: `explicit`
...
- Run folder: <repo>/examples/runs/review/run
- Result path: <repo>/examples/runs/review/run/reports/result.json

## Reports

- Run result: <repo>/examples/runs/review/run/reports/result.json
- review result: <repo>/examples/runs/review/run/reports/review-result.json
